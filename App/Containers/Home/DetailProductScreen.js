  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
      ...
      <View style={apply("items-center justify-center -mt-35")}>
        <Image
          source={item.image}
          style={[apply("w-250 h-250"), { marginTop: "10%" }]}
        />
      </View>
      <View style={apply("self-end -mt-120 px-4 mb-5")}>
        <Button
          style={apply(
            "w-48 h-40 b-10 border border-gray-500 my-1 items-center justify-center"
          )}
        >
        ...
        <Button
          style={apply(
            "w-48 h-40 b-10 border border-red-400 my-1 items-center justify-center"
          )}
        >
          <Image source={item.image} style={apply("w-48 h-40")} />
        </Button>
      ...
      <View
        style={apply(
          "flex bg-white shadow border-top-right-radius-40 border-top-left-radius-40 p-5"
        )}
      >
        ...
        <View>
          ...
          <Text style={apply("text-14 font-reguar")}>
            {item.desc.substr(0, 100)}...{" "}
            <Text style={apply("text-14 font-medium color-primary")}>
              Read More
            </Text>
          </Text>
        </View>
        ...
        <View style={apply("mb-5 row items-center")}>
          <Button
            style={apply(
              "w-48 h-40 b-10 border border-gray-400 my-1 items-center justify-center mr-3"
            )}
          >
          ...
          <Button
            style={apply(
              "w-48 h-40 b-10 border border-red-400 my-1 items-center justify-center mr-3"
            )}
          >
          ...
          <Button
            style={apply(
              "w-48 h-40 b-10 border border-gray-400 my-1 items-center justify-center"
            )}
          >
        ...
        <Button
          style={apply("h-50 bg-primary b-16 items-center justify-center")}
        >
          <Text style={apply("text-16 font-medium text-white")}>
            Add To Cart
          </Text>
        </Button>
      </View>
